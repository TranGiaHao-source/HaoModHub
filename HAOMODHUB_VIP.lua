    ...
    if success and result then
        v466 = result:MakeWindow({
            ...
            Theme = {
                ...
                SecondaryBackground = Color3.fromRGB(15, 15, 40),
...
if not ui_loaded then
    ...
    title.Text = "🌸 NaNa TV Hub - Blox Fruits VIP"
...
l_ImageButton_0.TextColor3 = Color3.fromRGB(0, 191, 255)
l_ImageButton_0.TextSize = 16
l_ImageButton_0.Font = Enum.Font.GothamBold
l_ImageButton_0.BackgroundColor3 = Color3.fromRGB(10, 10, 30)
...
l_UIStroke_0.Color = Color3.fromRGB(0, 191, 255)
