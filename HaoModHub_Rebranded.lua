-- HÀO MOD HUB | Blox Fruits Script
-- Rebranded from HÀO MOD HUB với màu đen xanh dương dạ quang
-- Key: HaoModHub

-- ============================================
-- PHẦN 1: GAME DETECTION & BASIC SETUP
-- ============================================
...
-- ============================================
-- PHẦN 2: LOAD TẤT CẢ FUNCTIONS TỪ FILE GỐC
-- ============================================
                ...
                if not isnil(l_v28_0.Character) then
                    ...
                    elseif not isnil(l_v28_0.Character.Head) and not l_v28_0.Character.Head:FindFirstChild("NameEsp" .. Number) then
                        ...
                        if l_v28_0.Team == game.Players.LocalPlayer.Team then
                            ...
                            v31.TextColor3 = Color3.new(0, 180, 255)
                        end
                    else
                ...
                if l_v45_0.Name == "Flower2" or l_v45_0.Name == "Flower1" then
                    if FlowerESP then
                        if l_v45_0:FindFirstChild("NameEsp" .. Number) then
                            ...
                            v48.TextColor3 = Color3.fromRGB(0, 180, 255)
    ...
    for _, v50 in pairs(game.Workspace.AppleSpawner:GetChildren()) do
        if v50:IsA("Tool") then
            ...
            elseif v50.Handle:FindFirstChild("NameEsp" .. Number) then
                ...
                v52.TextColor3 = Color3.fromRGB(0, 180, 255)
                    ...
                    if ESPPlayer then
                        if not isnil(l_v72_0.Character.Head) and not l_v72_0.Character.Head:FindFirstChild("NameEsp" .. Number) then
                            ...
                            if l_v72_0.Team == game.Players.LocalPlayer.Team then
                                ...
                                v75.TextColor3 = Color3.new(0, 180, 255)
                            end
                        else
            ...
            pcall(function()
                if l_v89_0.Name == "Flower2" or l_v89_0.Name == "Flower1" then
                    ...
                    elseif l_v89_0:FindFirstChild("NameEsp" .. Number) then
                        ...
                        v92.TextColor3 = Color3.fromRGB(0, 180, 255)
    ...
    for _, v94 in pairs(game.Workspace.AppleSpawner:GetChildren()) do
        if v94:IsA("Tool") then
            ...
            elseif v94.Handle:FindFirstChild("NameEsp" .. Number) then
                ...
                v96.TextColor3 = Color3.fromRGB(0, 180, 255)
                    ...
                    if ESPPlayer then
                        if isnil(l_v116_0.Character.Head) or l_v116_0.Character.Head:FindFirstChild("NameEsp" .. Number) then
                            ...
                            if l_v116_0.Team ~= game.Players.LocalPlayer.Team then
                                v119.TextColor3 = Color3.new(0, 180, 255)
                            else
                ...
                if l_v133_0.Name == "Flower2" or l_v133_0.Name == "Flower1" then
                    if FlowerESP then
                        if l_v133_0:FindFirstChild("NameEsp" .. Number) then
                            ...
                            v136.TextColor3 = Color3.fromRGB(0, 180, 255)
        ...
        if v138:IsA("Tool") then
            if RealFruitESP then
                if v138.Handle:FindFirstChild("NameEsp" .. Number) then
                    ...
                    v140.TextColor3 = Color3.fromRGB(0, 180, 255)
                ...
                if not isnil(l_v160_0.Character) then
                    ...
                    elseif isnil(l_v160_0.Character.Head) or l_v160_0.Character.Head:FindFirstChild("NameEsp" .. Number) then
                        ...
                        if l_v160_0.Team == game.Players.LocalPlayer.Team then
                            ...
                            v163.TextColor3 = Color3.new(0, 180, 255)
                        end
                    end
                end
            end)
            ...
            pcall(function()
                if l_v177_0.Name == "Flower2" or l_v177_0.Name == "Flower1" then
                    ...
                    elseif l_v177_0:FindFirstChild("NameEsp" .. Number) then
                        ...
                        v180.TextColor3 = Color3.fromRGB(0, 180, 255)
        ...
        if v182:IsA("Tool") then
            if RealFruitESP then
                if v182.Handle:FindFirstChild("NameEsp" .. Number) then
                    ...
                    v184.TextColor3 = Color3.fromRGB(0, 180, 255)
                    ...
                    if ESPPlayer then
                        if isnil(l_v204_0.Character.Head) or l_v204_0.Character.Head:FindFirstChild("NameEsp" .. Number) then
                            ...
                            if l_v204_0.Team ~= game.Players.LocalPlayer.Team then
                                v207.TextColor3 = Color3.new(0, 180, 255)
                            else
            ...
            pcall(function()
                if l_v221_0.Name == "Flower2" or l_v221_0.Name == "Flower1" then
                    ...
                    elseif l_v221_0:FindFirstChild("NameEsp" .. Number) then
                        ...
                        v224.TextColor3 = Color3.fromRGB(0, 180, 255)
    ...
    for _, v226 in pairs(game.Workspace.AppleSpawner:GetChildren()) do
        if v226:IsA("Tool") then
            ...
            elseif v226.Handle:FindFirstChild("NameEsp" .. Number) then
                ...
                v228.TextColor3 = Color3.fromRGB(0, 180, 255)
                    ...
                    if ESPPlayer then
                        if not isnil(l_v248_0.Character.Head) and not l_v248_0.Character.Head:FindFirstChild("NameEsp" .. Number) then
                            ...
                            if l_v248_0.Team ~= game.Players.LocalPlayer.Team then
                                v251.TextColor3 = Color3.new(0, 180, 255)
                            else
                ...
                if l_v265_0.Name == "Flower2" or l_v265_0.Name == "Flower1" then
                    if FlowerESP then
                        if l_v265_0:FindFirstChild("NameEsp" .. Number) then
                            ...
                            v268.TextColor3 = Color3.fromRGB(0, 180, 255)
        ...
        if v270:IsA("Tool") then
            if RealFruitESP then
                if not v270.Handle:FindFirstChild("NameEsp" .. Number) then
                    ...
                    v272.TextColor3 = Color3.fromRGB(0, 180, 255)
                ...
                for _, v344 in pairs(l_v341_0:GetAttributes()) do
                    if not v344 then
                        ...
                        if not l_v341_0.Parent:FindFirstChild("BerryESP") then
                            ...
                            v346.TextColor3 = Color3.fromRGB(0, 180, 255)
                            v346.Text = v344
                        end
...
-- ============================================
-- PHẦN 3: UI SYSTEM VỚI MÀU ĐEN XANH DƯƠNG DẠ QUANG
-- ============================================
...
for i, url in ipairs(ui_urls) do
    ...
    if success and result then
        v466 = result:MakeWindow({
            Title = "HÀO MOD HUB",
            SubTitle = "by Hào Mod Game",
            SaveFolder = "HaoModHub | redz lib v5.lua"
        })
        ui_loaded = true
...
-- Nếu không load được, tạo UI backup đơn giản với màu đen xanh dương
if not ui_loaded then
    warn("❌ Không thể load UI library! Tạo UI backup...")
    
    -- Tạo notification
    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "⚠️ HÀO MOD HUB - Lỗi!";
        Text = "Không thể load UI!\nThử executor khác!";
        Duration = 10;
    })
    
    -- Tạo UI đơn giản thay thế với màu đen xanh dương dạ quang
    ...
    -- KEY FRAME
    if KeySystemEnabled and not KeyEntered then
        local keyFrame = Instance.new("Frame")
        keyFrame.Name = "KeyFrame"
        keyFrame.Size = UDim2.new(0, 400, 0, 250)
        keyFrame.Position = UDim2.new(0.5, -200, 0.5, -125)
        keyFrame.BackgroundColor3 = Color3.fromRGB(10, 15, 25)  -- Đen xanh đậm
        ...
        keyStroke.Color = Color3.fromRGB(0, 255, 255)  -- Xanh dương dạ quang
        ...
        keyTitle.BackgroundColor3 = Color3.fromRGB(0, 180, 255)  -- Xanh dương sáng
        ...
        -- Logo (sử dụng placeholder - bạn có thể upload lên Roblox)
        local logo = Instance.new("ImageLabel")
        logo.Size = UDim2.new(0, 80, 0, 80)
        logo.Position = UDim2.new(0.5, -40, 0, 70)
        logo.BackgroundTransparency = 1
        logo.Image = "rbxassetid://15487421393"  -- Placeholder, thay bằng logo của bạn
        logo.Parent = keyFrame
        
        local keyInput = Instance.new("TextBox")
        keyInput.Size = UDim2.new(0.85, 0, 0, 40)
        keyInput.Position = UDim2.new(0.075, 0, 0, 160)
        keyInput.PlaceholderText = "Nhập Key: HaoModHub"
        ...
        keyInputStroke.Color = Color3.fromRGB(0, 180, 255)
        keyInputStroke.Thickness = 2
        keyInputStroke.Parent = keyInput
        
        local keyBtn = Instance.new("TextButton")
        keyBtn.Size = UDim2.new(0.85, 0, 0, 40)
        keyBtn.Position = UDim2.new(0.075, 0, 0, 210)
        keyBtn.Text = "✔️ XÁC NHẬN"
        keyBtn.BackgroundColor3 = Color3.fromRGB(0, 180, 255)
        ...
        keyBtn.MouseButton1Click:Connect(function()
            if CheckKey(keyInput.Text) then
                ...
                game:GetService("StarterGui"):SetCore("SendNotification", {
                    Title = "✅ HÀO MOD HUB";
                    Text = "Key chính xác! Đang load...";
                    Duration = 3;
                })
                
                -- Load main UI
                task.wait(0.5)
                -- Tiếp tục load phần main
            else
                keyBtn.Text = "❌ SAI KEY!"
        ...
        return  -- Dừng ở đây cho đến khi nhập key
    end
    
    -- MAIN FRAME (sau khi nhập key)
    local main = Instance.new("Frame")
    main.Name = "MainFrame"
    main.Size = UDim2.new(0, 500, 0, 350)
    main.Position = UDim2.new(0.5, -250, 0.5, -175)
    main.BackgroundColor3 = Color3.fromRGB(10, 15, 25)  -- Đen xanh đậm
    ...
    mainStroke.Color = Color3.fromRGB(0, 255, 255)  -- Xanh dương dạ quang
    ...
    title.BackgroundColor3 = Color3.fromRGB(0, 180, 255)  -- Xanh dương sáng
    title.Text = "💠 HÀO MOD HUB - Blox Fruits VIP 💠"
...
📋 Nguyên nhân có thể:
  • Executor không hỗ trợ game:HttpGet()
...
✅ Giải pháp:
  ...
  4. Liên hệ Hào Mod Game để hỗ trợ

⚠️ Script KHÔNG THỂ hoạt động nếu không load được UI!

💎 HÀO MOD HUB - Premium Quality 💎
]]
    infoText.TextColor3 = Color3.fromRGB(0, 255, 255)  -- Xanh dương dạ quang
...
-- TOGGLE BUTTON với màu đen xanh dương dạ quang
local l_ScreenGui_0 = Instance.new("ScreenGui")
l_ScreenGui_0.Name = "HaoModControlGUI"
...
l_ImageButton_0.Image = "rbxassetid://15487421393"  -- Placeholder, thay bằng logo của bạn
l_ImageButton_0.BackgroundColor3 = Color3.fromRGB(10, 15, 25)
...
l_UIStroke_0.Color = Color3.fromRGB(0, 255, 255)  -- Xanh dương dạ quang
l_UIStroke_0.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
l_UIStroke_0.Parent = l_ImageButton_0

-- Glow animation cho toggle button
task.spawn(function()
    while true do
        for i = 0, 1, 0.02 do
            l_UIStroke_0.Transparency = i
            task.wait(0.03)
        end
        for i = 1, 0, -0.02 do
            l_UIStroke_0.Transparency = i
...
l_ImageButton_0.MouseButton1Click:Connect(function()
    v473 = not v473
    game.CoreGui:FindFirstChild("UILibrary"):FindFirstChild("Main").Visible = v473
end)
