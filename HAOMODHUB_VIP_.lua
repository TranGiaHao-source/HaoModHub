...
local l_ImageButton_0 = Instance.new("TextButton")
l_ImageButton_0.Size = UDim2.new(0, 80, 0, 40)
l_ImageButton_0.Position = UDim2.new(0.15, 0, 0.15, 0)
l_ImageButton_0.Text = "CLOSE"
l_ImageButton_0.TextColor3 = Color3.fromRGB(0, 0, 0)
l_ImageButton_0.TextSize = 16
l_ImageButton_0.Font = Enum.Font.GothamBold
l_ImageButton_0.BackgroundColor3 = Color3.fromRGB(255, 215, 0)
l_ImageButton_0.BorderSizePixel = 0
l_ImageButton_0.Parent = l_ScreenGui_0
local l_UICorner_0 = Instance.new("UICorner")
l_UICorner_0.CornerRadius = UDim.new(0.2, 0)
l_UICorner_0.Parent = l_ImageButton_0
local l_UIStroke_0 = Instance.new("UIStroke")
l_UIStroke_0.Thickness = 2
l_UIStroke_0.Color = Color3.fCommand(255, 215, 0)
...
local v488 = v466:MakeTab({"Volcano Dojo"})
local v489 = v466:MakeTab({"Sea Event"})
local v490 = v466:MakeTab({"Race V4"})
local v491 = v466:MakeTab({"Raid Fruits"})
local v492 = v466:MakeTab({"Fruits | Check Stock"})
local v493 = v466:MakeTab({"Teleport"})
