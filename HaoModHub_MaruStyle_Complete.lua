--// =========================================
--// HÀO MOD HUB | MARU STYLE UI - FULL VERSION
--// ✅ UI: Maru Style với màu đen xanh dương dạ quang  
--// ✅ Chức năng: 100% từ NaNa Hub
--// ✅ Key: HaoModHub
--// =========================================

-- Load toàn bộ functions và logic từ file gốc trước
...
-- ============================================
-- MARU STYLE UI WITH BLACK & CYAN NEON THEME
-- ============================================
...
-- Xóa UI cũ nếu có
if parentGui:FindFirstChild("HaoModHubUI") then
    parentGui:FindFirstChild("HaoModHubUI"):Destroy()
end
...
Toggle.Parent = gui
Toggle.Size = UDim2.fromScale(0.075,0.13)
Toggle.Position = UDim2.fromScale(0.02,0.42)
Toggle.BackgroundColor3 = Color3.fromRGB(10,10,15)
Toggle.Image = "rbxassetid://15487421393"
...
ToggleText.Size = UDim2.fromScale(1,0.28)
ToggleText.Position = UDim2.fromScale(0.5,0.86)
ToggleText.AnchorPoint = Vector2.new(0.5,0.5)
ToggleText.BackgroundTransparency = 1
ToggleText.Text = "OPEN"
ToggleText.Font = Enum.Font.GothamBold
ToggleText.TextSize = 14
ToggleText.TextColor3 = Color3.fromRGB(0,180,255)
...
KeyFrame.Parent = gui
KeyFrame.Size = UDim2.fromScale(0.4,0.35)
...
-- Glow animation cho KeyFrame
task.spawn(function()
    while KeyFrame.Parent and KeyFrame.Visible do
        for i = 0, 1, 0.02 do
...
KeyBox.PlaceholderText = "Enter Key: HaoModHub"
...
KeyBtn.Size = UDim2.fromScale(0.5,0.18)
KeyBtn.Position = UDim2.fromScale(0.5,0.72)
KeyBtn.AnchorPoint = Vector2.new(0.5,0.5)
KeyBtn.Text = "✔️ VERIFY KEY"
...
Top.BackgroundColor3 = Color3.fromRGB(0,140,255)
Top.Text = "💠 HÀO MOD HUB 💠"
...
Sidebar.ScrollBarImageColor3 = Color3.fromRGB(0,180,255)
...
PageContainer.Size = UDim2.new(0.70,-5,1,0)
PageContainer.Position = UDim2.new(0.28,5,0,0)
...
local function CreateTab(name, icon)
    ...
    TabBtn.MouseButton1Click:Connect(function()
        for _, tab in pairs(Tabs) do
            ...
            tab.Button.BackgroundColor3 = Color3.fromRGB(15,15,20)
    ...
    return {
        ...
        AddToggle = function(self, config)
            ...
            ToggleBtn.MouseButton1Click:Connect(function()
                ...
                ToggleBtn.BackgroundColor3 = isOn and Color3.fromRGB(0,180,255) or Color3.fromRGB(150,50,50)
        ...
        AddDropdown = function(self, config)
            ...
            DropBtn.Size = UDim2.new(0.50,-10,0,25)
            DropBtn.Position = UDim2.new(0.50,0,0.5,0)
            DropBtn.AnchorPoint = Vector2.new(0,0.5)
            DropBtn.Text = config.Default or config.Options[1] or "Select"
            DropBtn.Font = Enum.Font.Gotham
            DropBtn.TextSize = 12
            DropBtn.BackgroundColor3 = Color3.fromRGB(25,25,30)
            DropBtn.TextColor3 = Color3.new(1,1,1)
            Instance.new("UICorner", DropBtn).CornerRadius = UDim.new(0,6)

            local DropList = Instance.new("Frame")
            DropList.Parent = DropFrame
            DropList.Size = UDim2.new(1,0,0,math.min(#config.Options * 35, 200))
            DropList.Position = UDim2.new(0,0,1,5)
            DropList.BackgroundColor3 = Color3.fromRGB(20,20,25)
        ...
        AddSection = function(self, text)
            ...
            Section.TextSize = 18
            Section.TextColor3 = Color3.fromRGB(0,180,255)
...
-- ============================================
-- CREATE ALL TABS (giống NaNa Hub)
-- ============================================

local InfoTab = CreateTab("📋 Info")
local FarmTab = CreateTab("⚔️ Farming")
...
if #Tabs > 0 then
    ...
    first.Button.BackgroundColor3 = Color3.fromRGB(0,140,255)
    first.Button.TextColor3 = Color3.new(1,1,1)
end
...
Toggle.MouseButton1Click:Connect(function()
    OPEN = not OPEN
    Main.Visible = OPEN
    ToggleText.Text = OPEN and "CLOSE" or "OPEN"
end)

KeyBtn.MouseButton1Click:Connect(function()
    if KeyBox.Text == "HaoModHub" then
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "✅ HÀO MOD HUB";
            Text = "Key đúng! Chào mừng bạn!";
            Duration = 3;
        })
    else
        KeyBtn.Text = "❌ WRONG KEY"
        KeyBtn.BackgroundColor3 = Color3.fromRGB(255,50,50)
        task.wait(1)
        KeyBtn.Text = "✔️ VERIFY KEY"
        KeyBtn.BackgroundColor3 = Color3.fromRGB(0,140,255)
    end
...
game:GetService("StarterGui"):SetCore("SendNotification", {
    Title = "💠 HÀO MOD HUB 💠";
    Text = "Script loaded! Enter key: HaoModHub";
    Duration = 5;
})

print("========================================")
print("✅ HÀO MOD HUB LOADED SUCCESSFULLY!")
print("🔑 Key: HaoModHub")
print("💎 Maru Style UI - Black & Cyan Neon")
print("========================================")
...
local _ = FarmTab:AddSection({"Select Melee,Sword,Gun,Fruit"})
...
local _ = FarmTab:AddSection({"Main Farm"})
FarmTab:AddToggle({
...
local _ = FarmTab:AddSection({"Farm Summer Token New"})
FarmTab:AddToggle({
...
local _ = FarmTab:AddSection({"Event Boss Pain New"})
local v537 = {}
if World1 then
    v537 = {
        "The Gorilla King",
...
local _ = FarmTab:AddSection({"AutoRaidPirate"})
FarmTab:AddToggle({
    Name = "Farm Pirate",
...
local _ = FarmTab:AddSection({"TyrantoftheSkies"})
local v548 = FarmTab:AddParagraph({Title = "Check Eyes Status", Content = "Loading..."})
task.spawn(function()
...
local _ = FarmTab:AddSection({"X\198\176\198\161ng"})
local v589 = FarmTab:AddParagraph({Title = "Check Bone", Content = "Loading..."})
task.spawn(function()
    while task.wait(1) do
        pcall(function()
...
local _ = FarmTab:AddSection({"Katakuri"})
local v606 = FarmTab:AddParagraph({Title = "Check Cake Prince", Content = "Loading..."})
task.spawn(function()
    while task.wait(1) do
        pcall(function()
...
local _ = FarmTab:AddSection({"Auto Farm Chest And Berry"})
FarmTab:AddToggle({
...
local _ = FarmTab:AddSection({"Boss Fram"})
FarmTab:AddButton({
...
local v657 = FarmTab:AddParagraph({Title = "Boss Spawn Status", Content = "Initializing..."})
task.spawn(function()
    while task.wait(1) do
        pcall(function()
...
local _ = FarmTab:AddSection({"Material"})
local v664 = {}
if not World1 then
    if World2 then
...
local _ = FishingTab:AddSection({"Auto Fishing |  T\225\187\177 \196\144\225\187\153ng C\195\162u C\195\161"})
...
if World1 then
    local _ = ItemTab:AddSection({"Quest Sea 1"})
    ItemTab:AddToggle({
        Name = "AutoSecondSea",
    ...
    local _ = ItemTab:AddSection({"Boss Greybeard"})
    ItemTab:AddToggle({
        Name = "Kill Greybeard",
    ...
    local _ = ItemTab:AddSection({"Quest Sword"})
    ItemTab:AddToggle({
        Name = "Auto Get Saber",
...
if World2 then
    local _ = ItemTab:AddSection({"Quest Sea 2"})
    ItemTab:AddToggle({
    ...
    local _ = ItemTab:AddSection({"Factory Sea 2"})
    ItemTab:AddToggle({
        Name = "Auto Factory",
    ...
    local _ = ItemTab:AddSection({"Boss Dark Beard"})
    ItemTab:AddToggle({
    ...
    local _ = ItemTab:AddSection({"Auto Buy Haki M\195\160u"})
    ItemTab:AddToggle({
...
if World3 then
    local _ = ItemTab:AddSection({"Quest Sea 3"})
    local _ = ItemTab:AddSection({"Boss Rip indra"})
    ItemTab:AddToggle({
    ...
    do
        ...
        local _ = ItemTab:AddSection({"Quest Skull Guitar"})
        ItemTab:AddToggle({
        ...
        local _ = ItemTab:AddSection({"Auto CDK"})
        ItemTab:AddToggle({
            Name = "Auto Cdk [Beta]",
...
local _ = DojoTab:AddSection({"Volcanic Island"})
DojoTab:AddButton({
...
local v850 = DojoTab:AddParagraph({Title = "Check Prehistoric Island", Content = "Loading..."})
task.spawn(function()
    while task.wait(1) do
        pcall(function()
...
local _ = DojoTab:AddSection({"Auto Skill"})
DojoTab:AddToggle({
    Name = "Auto Use Melee",
...
local _ = DojoTab:AddSection({"Auto Kill Golem"})
DojoTab:AddToggle({
...
local _ = DojoTab:AddSection({"Auto Collect Bone,Egg"})
DojoTab:AddToggle({
...
local _ = SeaEventTab:AddSection({"Kitsune Island"})
local v939 = SeaEventTab:AddParagraph({Title = "Check Kitsune Island", Content = "Loading..."})
task.spawn(function()
    while task.wait(1) do
        pcall(function()
...
local _ = SeaEventTab:AddSection({"Sea Events"})
SeaEventTab:AddToggle({
...
local _ = SeaEventTab:AddSection({"Mirage Island"})
local v984 = SeaEventTab:AddParagraph({Title = "Check Mirage Island", Content = "Loading..."})
task.spawn(function()
    while task.wait(1) do
        pcall(function()
...
local _ = RaceTab:AddSection({"Teleport V4"})
RaceTab:AddButton({
...
local _ = RaceTab:AddSection({"Trial V4"})
RaceTab:AddButton({
...
local _ = RaceTab:AddSection({"Auto Skill"})
RaceTab:AddToggle({
    Name = "Auto Skill Z",
...
local _ = RaidTab:AddSection({"Raid Fruits"})
RaidTab:AddDropdown({
    Name = "Select Chip",
    Options = {
        "Flame",
...
local _ = RaidTab:AddSection({"Raid Law Sea 2"})
RaidTab:AddButton({
...
local _ = FruitTab:AddSection({"Fruits"})
FruitTab:AddToggle({
...
local _ = FruitTab:AddSection({"Check Stock Fruits"})
...
local v1112 = FruitTab:AddParagraph({
...
local _ = TeleportTab:AddSection({"Teleport Island | Di Chuy\225\187\131n \196\144\225\186\191n \196\144\225\186\163o"})
...
local _ = TeleportTab:AddSection({"Teleport Sea | Di Chuy\225\187\131n Sea 1,2,3"})
...
local _ = PvPTab:AddSection({"Teleport Player | Di Chuy\225\187\131n \196\144\225\186\191n Player"})
local v1123 = {}
...
local _ = PvPTab:AddSection({"Buff"})
...
local _ = PvPTab:AddSection({"Esp | \196\144\225\187\139nh V\225\187\139..."})
PvPTab:AddToggle({
    Title = "Esp Players",
    Value = false,
...
local _ = ShopTab:AddSection({"Buy Melee V1"})
ShopTab:AddButton({
...
local _ = ShopTab:AddSection({"Buy Melee V2"})
ShopTab:AddButton({
...
local _ = ShopTab:AddSection({"Buy Sea Event Crafting"})
ShopTab:AddButton({
...
local _ = ShopTab:AddSection({"Buy Haki,Soru..."})
ShopTab:AddButton({
...
local _ = ShopTab:AddSection({"Buy Sword,Gun"})
ShopTab:AddButton({
...
local _ = ShopTab:AddSection({"Reset Stats , Random Race"})
ShopTab:AddButton({
...
local _ = MiscTab:AddSection({"Settings Farming"})
MiscTab:AddParagraph({Title = "Unban Fast Attack - M1 Fruit", Content = "On: \226\156\133"})
...
MiscTab:AddToggle({Title = "Infinite Soru", Value = false, Callback = function(v1170)
    _G.AutoHaki = v1170
end})
spawn(function()
    while task.wait(0.1) do
...
MiscTab:AddToggle({Title = "Infinite Soru", Value = false, Callback = function(v1173)
    InfiniteSoru = v1173
end})
spawn(function()
    while task.wait(1) do
...
PosY = 30
MiscTab:AddToggle({Title = "Dodge No CD", Value = false, Callback = function(v1178)
...
MiscTab:AddToggle({Title = "Infinite Geppo", Value = false, Callback = function(v1183)
    InfiniteGeppo = v1183
end})
spawn(function()
    while task.wait(1) do
...
MiscTab:AddToggle({Title = "Walk on Water", Value = true, Callback = function(v1188)
    _G.WalkWater = v1188
end})
spawn(function()
    while task.wait() do
...
local _ = MiscTab:AddSection({"Auto Increase Skill Points"})
...
local _ = MiscTab:AddSection({"Sea 1,2,3"})
MiscTab:AddButton({
    Title = "Join Sea 1",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
...
local _ = MiscTab:AddSection({"Other"})
MiscTab:AddButton({
...
local _ = MiscTab:AddSection({"Auto Codes"})
local v1218 = {
    "NOMOREHACK",
    "BANEXPLOIT",
    "WildDares",
...
local _ = MiscTab:AddSection({"Sever Hop"})
MiscTab:AddButton({
    Title = "Rejoin Server",
    Callback = function()
...
MiscTab:AddButton({Title = "Server Hop", Callback = function()
    Hop()
end})
return 
